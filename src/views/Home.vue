<template>
  <div class="page-wrapper">
    <h1 class="page-title">We’re launching soon</h1>

    <section class="countdown-wrapper">
      <div class="countdown-container">
        <div class="countdown-block">
          <div class="countdown-bg"></div>
          <p class="countdown-number" v-text="days < 10 ? `0${days}` : days"></p>
        </div>

        <p class="countdown-type">Days</p>
      </div>

      <div class="countdown-container">
        <div class="countdown-block">
          <div class="countdown-bg"></div>
          <p class="countdown-number" v-text="hours < 10 ? `0${hours}` : hours"></p>
        </div>

        <p class="countdown-type">Hours</p>
      </div>

      <div class="countdown-container">
        <div class="countdown-block">
          <div class="countdown-bg"></div>
          <p class="countdown-number" v-text="minutes < 10 ? `0${minutes}` : minutes"></p>
        </div>
      ...
      <div class="countdown-container">
        <div class="countdown-block">
          <div class="countdown-bg"></div>
          <p class="countdown-number" v-text="seconds < 10 ? `0${seconds}` : seconds"></p>
        </div>

        <p class="countdown-type">Seconds</p>
      </div>
    </section>
